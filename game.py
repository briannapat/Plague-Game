...
class Real():
    def __init__(self):
            ...
            self.actions = {"back": False, "escape": False, "w": False, "quit": False, "tab": False,"credits": False, "started": False, "left": False, "right": False, "up" : False, "down" : False, "action1" : False, "action2" : False, "start" : False, "q" : False, "controls" : False}
            self.state_stack = []   
